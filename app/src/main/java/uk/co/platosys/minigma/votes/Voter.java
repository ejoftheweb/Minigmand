...
public interface Voter {
     ...
     /**
      * Returns the signature of the Returning Officer as applied to the
      * @return
      */
     Signature getPollSignature();

     /**Called by the Poll object when a poll is called. The BigBinary passed as an argument is
      * the Ballot, encrypted with the Voter's public. It is accompanied by the Signature of the
